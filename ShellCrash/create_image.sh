...
docker run --restart=always --name=shellclash_docker --network=macvlan --ip=$container_ip --cap-add=NET_ADMIN -d openwrt/rootfs:x86-64 sleep infinity
# docker run --restart=always --name=shellclash_docker --network=macvlan --ip=$container_ip --cap-add=NET_ADMIN -d alpine
...
docker commit shellclash_docker syfly007/shellclash_docker:$TIMESTAMP
docker push syfly007/shellclash_docker:$TIMESTAMP
docker tag syfly007/shellclash_docker:$TIMESTAMP syfly007/shellclash_docker:latest
docker push syfly007/shellclash_docker:latest
...
docker rmi syfly007/shellclash_docker:$TIMESTAMP
docker rmi syfly007/shellclash_docker:latest
